...
namespace FlyModel.UI.Component
{
    ...
    public class TableView:BehaviourBase
    {
        ...
        public void NotifyCellDimensionsChanged(int row) {
            ...
            if (m_visibleRowRange.Contains(row)) {
                ...
                cell.GameObject.GetComponent<LayoutElement>().preferredHeight = m_rowHeights[row];
                if (row > 0) {
                    cell.GameObject.GetComponent<LayoutElement>().preferredHeight -= m_verticalLayoutGroup.spacing;
                }
            }
        ...
        public float scrollableHeight {
            get {
                ...
                return m_scrollRect.content.rect.height - (Transform as RectTransform).rect.height;
            }
        }
        ...
        void Awake()
        {
            ...
            m_verticalLayoutGroup = Transform.GetComponentInChildren<VerticalLayoutGroup>();
            ...
            m_reusableCellContainer.SetParent(Transform, false);
        ...
        private Range CalculateCurrentVisibleRowRange()
        {
            ...
            float endY = m_scrollY + (Transform as RectTransform).rect.height;
        ...
        private void AddRow(int row, bool atEnd)
        {
            ...
            newCell.GameObject.transform.SetParent(m_scrollRect.content, false);

            LayoutElement layoutElement = newCell.GameObject.GetComponent<LayoutElement>();
            ...
            if (atEnd) {
                newCell.GameObject.transform.SetSiblingIndex(m_scrollRect.content.childCount - 2); //One before bottom padding
            } else {
                newCell.GameObject.transform.SetSiblingIndex(1); //One after the top padding
            }
        ...
        private void StoreCellForReuse(TableViewCell cell) {
            ...
            cell.GameObject.transform.SetParent(m_reusableCellContainer, false);
        }
