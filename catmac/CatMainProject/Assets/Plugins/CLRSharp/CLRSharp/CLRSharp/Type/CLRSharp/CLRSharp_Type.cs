...
namespace CLRSharp
{
    public class Type_Common_CLRSharp : ICLRType_Sharp
    {
        ...
        List<Method_Common_CLRSharp> _methods;


        public List<Method_Common_CLRSharp> Methods
        {
            get
            {
                if (_methods == null)
                {
                    _methods = new List<Method_Common_CLRSharp>();
                    foreach (var m in type_CLRSharp.Methods)
                    {
                        _methods.Add(new Method_Common_CLRSharp(this, m));
                    }
                }
                return _methods;
            }
